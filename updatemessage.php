...
if(!isset($_SESSION['user'])){
  ...
  ?>
    <form method="post" class="form-x" action="updatemessagehd.php?id=<?=$row['id']?>" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="author" value=<?=$row['author']?> data-validate="required:请输入作者" />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
